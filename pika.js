...
var assetLoader = (function() {
  ...
  this.downloadAll = function() {
    var _this = this;
    var src;    for (var img in this.imgs) {
...
var player = (function(player) {  player.width     = 135;
  player.height    = 107;
  player.speed     = 6;
  player.gravity   = 1;
  player.dy        = 0;
...
function updateEnemies() {
  for (var i = 0; i < enemies.length; i++) {
    ...
    if ((player.minDist(enemies[i])+70) <= player.width - platformWidth/2) {
      gameOver();
    }
  }
